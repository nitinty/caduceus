...
func caduceus(arguments []string) int {
	...
	caduceusSenderWrapper, err := SenderWrapperFactory{
		...
		KafkaEnabled:                         caduceusConfig.Sender.Kafka.KafkaEnabled,
        		...
        		KafkaEnsureTopic:                     caduceusConfig.Sender.Kafka.KafkaEnsureTopic,
        		KafkaNumPartitions:                   caduceusConfig.Sender.Kafka.KafkaNumPartitions,
        		KafkaReplicationFactor:               caduceusConfig.Sender.Kafka.KafkaReplicationFactor,
        		KafkaAdminTimeoutMs:                  caduceusConfig.Sender.Kafka.KafkaAdminTimeoutMs,
        		...
        		KafkaLingerMs:                        caduceusConfig.Sender.Kafka.KafkaProducer.KafkaLingerMs,
        		KafkaBatchNumMessages:                caduceusConfig.Sender.Kafka.KafkaProducer.KafkaBatchNumMessages,
        		KafkaQueueBufferingMaxKbytes:         caduceusConfig.Sender.Kafka.KafkaProducer.KafkaQueueBufferingMaxKbytes,
        		KafkaQueueBufferingMaxMessages:       caduceusConfig.Sender.Kafka.KafkaProducer.KafkaQueueBufferingMaxMessages,
        		KafkaEnableIdempotence:               caduceusConfig.Sender.Kafka.KafkaProducer.KafkaEnableIdempotence,
        		KafkaMaxInFlight:                     caduceusConfig.Sender.Kafka.KafkaProducer.KafkaMaxInFlight,
        		KafkaDeliveryTimeoutMs:               caduceusConfig.Sender.Kafka.KafkaProducer.KafkaDeliveryTimeoutMs,
        		KafkaConsumerFetchMinBytes:           caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerFetchMinBytes,
        		KafkaConsumerFetchWaitMaxMs:          caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerFetchWaitMaxMs,
        		KafkaConsumerMaxPartitionFetchBytes:  caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerMaxPartitionFetchBytes,
        		KafkaConsumerQueuedMinMessages:       caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerQueuedMinMessages,
        		KafkaConsumerQueuedMaxMessagesKbytes: caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerQueuedMaxMessagesKbytes,
        		KafkaConsumerEnableAutoCommit:        caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerEnableAutoCommit,
        		KafkaConsumerAutoCommitIntervalMs:    caduceusConfig.Sender.Kafka.KafkaConsumer.KafkaConsumerAutoCommitIntervalMs,
	}.New()
